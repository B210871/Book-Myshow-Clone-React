    ...
    return (
        <>
            <div className="w-full h-30 px-2">
                <img className="w-full h-full rounded-xl" alt="Entertainment Image" src={props.src} />
            </div>
...
const EnterainmentCardSlider = () => {
    const EnterainmentImage = [
        ...
        "https://assets-in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:ote-OCBFdmVudHM%3D,otc-FFFFFF,otf-Roboto,ots-64,ox-48,oy-320,ott-b:w-300:q-80/arts-crafts-collection-202211140440.png",
